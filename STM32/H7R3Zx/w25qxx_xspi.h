...
/**
 * Modified from:
 * https://github.com/WeActStudio/WeActStudio.STM32H7R3Zx_CoreBoard/tree/master/Examples/02-MSC/Drivers/BSP/W25Qxx
 * 
 * Define `NOTICK` if no `SYSTICK` enabled like:
 * #define NOTICK   1
 * 
 * then, this enables `busy wait` for `W25Qxx` and, some delays.
 */
#include "main.h"
...
extern uint32_t XSPI_NOR_ID;
extern uint8_t XSPI_NOR_Register[3];
extern W25Qxx_Interface_t XSPI_NOR_Mode;
